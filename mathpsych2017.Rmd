...
$$
- Here, $\omega_j$ is the \textsc{ans} acuity of subject $j$, referred to as the *Weber fraction* (the larger $\omega_j$, the narrower the Gaussians of the mental number line, and so the better their ability to distinguish between different set sizes). 
